  ...
  return (
    <>
      ...
      <div style={{ position: "relative", zIndex: 2, marginTop: "10vh" }}>
        ...
        <div className="text-center pt-10 text-xl font-semibold mt-10">
          Your guide to attain
        </div>
        <div className="text-center text-5xl pt-6 mt-15 titlecolor">
          Interview
        </div>
        ...
        <div className="green-section1" style={{ margin: "10px" }}>
          <div className="flex">
            ...
            <div
              className="flex-1 p-5 text-black"
              style={{ fontWeight: "bold" }}
            >
              Ever felt like youve stumbled your way through an interview? Worry
              no longer, friend! Our platform is the wind at your back and the
              solid ground under your feet. A swirling blend of experience-based
              learning and expert guidance will take you from zero to interview
              hero.
            </div>
          </div>
        </div>
